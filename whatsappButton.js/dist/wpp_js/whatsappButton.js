...
function () {
  ...
  function WhatsappButton(pNumber, wMessage, phMessage, dMessage, iconStyle, color, subColor, textColor, fontFamily) {
    ...
    this.svgWhatsappPath = this.whatsappIcon ? "node_modules/whatsappButton.js/dist/wpp_icons/My icons collection-SVG-sprite.svg#".concat(this.whatsappIcon) : "node_modules/whatsappButton.js/dist/wpp_icons/My icons collection-SVG-sprite.svg#whatsapp";
