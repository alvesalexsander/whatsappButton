...
function () {
  ...
  function WhatsappButton(pNumber, wMessage, phMessage, dMessage, iconStyle, color, subColor, textColor, fontFamily) {
    ...
    this.svgWhatsappPath = this.whatsappIcon ? "wpp_icons/My icons collection-SVG-sprite.svg#".concat(this.whatsappIcon) : "wpp_icons/My icons collection-SVG-sprite.svg#whatsapp";
